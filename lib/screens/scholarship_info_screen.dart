...
class ScholarshipInfoScreen extends StatelessWidget {
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            _buildInfoCard(
              ...
              title: 'Objetivo',
              content: 'Propiciar que los estudiantes cuenten con un apoyo para continuar su formación profesional, atendiendo políticas de equidad para estudiantes con capacidades diferentes o situaciones particulares, buscando la permanencia y continuación de sus estudios.',
            ),
            _buildInfoCard(
              context,
              icon: Icons.groups_outlined,
              title: 'Población Objetivo',
              content: 'Todo el estudiantado inscrito en el TecNM – Instituto Tecnológico de Colima.',
            ),
            _buildInfoCard(
              context,
              icon: Icons.restaurant_menu_outlined,
              title: 'Características de la Beca',
              content: 'Consisten en el otorgamiento de servicios alimenticios en las cafeterías del Instituto, con un horario de 08:00 a 17:00 horas y de acuerdo al calendario escolar vigente.',
            ),
            _buildInfoCard(
              context,
              icon: Icons.checklist_rtl_outlined,
              title: 'Criterios de Selección',
              content: 'Los aspirantes que cumplan con el requisito serán seleccionados prioritariamente en función de los siguientes criterios:\n\n(A) Con situación económica adversa.\n(B) Con capacidades diferentes.\n(C) Que sean madres solteras o embarazadas.\n(D) Que su lugar de residencia esté alejado del instituto.\n(E) Que su carga horaria les obligue a estar un mayor número de horas en la institución, siempre y cuando no se deba a reprobación.\n(F) Que preferentemente no cuenten con algún beneficio equivalente de tipo económico o en especie otorgado por organismos públicos o privados.\n(G) Que participen en equipos o grupos representativos de la institución.',
            ),
            _buildInfoCard(
              context,
  ...
  Widget _buildInfoCard(BuildContext context, {required IconData icon, required String title, required String content, bool isLast = false}) {
    final theme = Theme.of(context);
    return Card(
      elevation: 2.0,
